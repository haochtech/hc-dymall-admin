...

{
...

    {
        ...
        define_once('WE7_MODULE_NAME', 'zxdy_mall');

        define_once('WE7_TABLE_PREFIX', 'zxdy_');
   ...
   /**
     ...
     * Detect if this request sending from tt app
    ...
    public function fromTouTiaoApp()

    {

        return $this->request->getParam('_platform') === 'tt';
