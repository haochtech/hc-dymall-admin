...
class MchAddForm extends MchModel
{
    ...
    {
        return [
            [['user_id', 'realname', 'tel','password', 'name', 'wechat_name',  'province_id', 'city_id', 'district_id', 'address', 'mch_common_cat_id', 'service_tel', 'logo', 'header_bg', 'transfer_rate', 'sort'], 'trim'],
            [['user_id', 'realname', 'tel','password', 'name', 'province_id', 'city_id', 'district_id', 'address', 'mch_common_cat_id', 'service_tel', 'transfer_rate',], 'required'],
