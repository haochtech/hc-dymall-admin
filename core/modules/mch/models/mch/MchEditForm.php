...
class MchEditForm extends MchModel
{
    ...
    {
        $rules = [
            [['realname', 'tel','password','wechat_name', 'name', 'address', 'service_tel', 'logo', 'header_bg', 'review_result'], 'trim'],
            [['realname', 'tel','password', 'name', 'province_id', 'city_id', 'district_id', 'address', 'mch_common_cat_id', 'service_tel'], 'required'],
            [['realname', 'tel','password', 'name', 'province_id', 'city_id', 'district_id', 'address', 'mch_common_cat_id', 'service_tel'], 'string','max'=>250],
            [['user_id'], 'integer'],
