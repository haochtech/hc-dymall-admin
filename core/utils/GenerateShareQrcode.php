...
class GenerateShareQrcode
{
    ...
    public static function getQrcode1($storeId, $scene, $width = 430, $page = null)

    {
        ...
        if (\Yii::$app->fromAlipayApp()) {
            ...
            return $model->toutiao1($scene, $storeId, $width, $page);
...
//        }
    ...
    public function toutiao1($scene, $storeId, $width = 430, $page = null)
